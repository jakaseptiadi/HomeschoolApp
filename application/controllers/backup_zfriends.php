...
class Z_friends extends CI_Controller {
	...
	public function follow($id, $type_id){
		 ...
		 $follow = array(
            'tutor_id' => $_SESSION['tutor_id'],
             ($type_id=="idtutor"?'tutor_id2':'student_id2') => $id
        );
	...
	public function check_friends($id, $type_id){
		...
		$data = $this->z_model_friends->countdata2c('t_z_relationship', $param1, $param2, $value1, $value2);
	...
	public function unfollow($id, $type_id){
		...
		$data = $this->z_model_friends->unfollow('t_z_relationship', $param1, $param2, $value1, $value2);
