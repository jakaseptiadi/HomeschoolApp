				...
				<div class="col-md-6 col-md-offset-3">
					<div class="panel panel-headline">
						<div class="panel-heading text-center">
							<h3 class="panel-title">SIGNIN STUDENT</h3>
						</div>
						<div class="panel-body text-center">
							...
							<?php } ?>
							<img src="<?php echo base_url('assets/img/student.png');?>" width="200px">
							<p class="text-justify">
								<form class="form form-horizontal" action="<?php echo site_url('student'); ?>" method="POST">
								<label class="control-label" for="email">Email/Username</label>
								<div class="form-group">
									<input name="emailorusername" type="text" class="form-control" placeholder="Email/username" id="email" required="">
								</div>
